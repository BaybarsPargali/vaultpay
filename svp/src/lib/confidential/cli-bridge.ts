...
const WSL_SOLANA_BIN = '/home/YOUR_USER/.local/share/solana/install/active_release/bin';
  ...
  private buildCommand(subcommand: string, args: string[]): string {
    ...
    if (this.config.keypairPath) {
      ...
      if (IS_WINDOWS && !keypairPath.startsWith('/')) {
        ...
        keypairPath = process.env.WSL_SOLANA_KEYPAIR || '/home/YOUR_USER/.config/solana/id.json';
      }
