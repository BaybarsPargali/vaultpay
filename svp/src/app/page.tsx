...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen min-h-screen-dvh bg-gradient-to-br from-gray-900 via-purple-900/80 to-gray-900 relative gradient-mesh" suppressHydrationWarning>
      ...
      {/* NEW: Privacy Architecture - Co-Signer Pattern */}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-8 text-center hover:border-green-500/30 transition-all hover:-translate-y-1">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">Zero-Knowledge Privacy</h3>
              <p className="text-gray-400 text-sm sm:text-base">
                Amounts encrypted using Twisted ElGamal (Token-2022). The network validates the math, not the data.
              </p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-8 text-center hover:border-purple-500/30 transition-all hover:-translate-y-1">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">Compliance Co-Signer</h3>
              <p className="text-gray-400 text-sm sm:text-base">
                Arcium MPC acts as a 2-of-2 signer. Funds only move if the destination passes real-time OFAC/sanctions screening.
              </p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-8 text-center hover:border-cyan-500/30 transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-400 text-sm sm:text-base">
                No escrow smart contract. Funds move directly from your vault to the employee, encrypted every step of the way.
              </p>
            </div>
          </div>

          {/* Powered by Arcium badge */}
          <div className="mt-8 sm:mt-12 text-center">
            <a 
      ...
      <section className="relative z-10 px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <a href="https://squads.so" target="_blank" rel="noopener noreferrer" className="glass-card rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 hover:border-yellow-500/30 transition-all group">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                ...
                <div>
                  <div className="text-white font-semibold text-sm sm:text-base">Squads Protocol</div>
                  <div className="text-gray-500 text-xs sm:text-sm">Multi-sig Infrastructure</div>
                </div>
              </div>
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Formally verified smart accounts securing billions in assets across the Solana ecosystem.
              </p>
            </a>

            <a href="https://helius.dev" target="_blank" rel="noopener noreferrer" className="glass-card rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 hover:border-purple-500/30 transition-all group">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                SOC 2 certified RPC infrastructure with high availability for reliable Solana connectivity.
              </p>
            </a>

            <a href="https://arcium.com" target="_blank" rel="noopener noreferrer" className="glass-card rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 hover:border-cyan-500/30 transition-all sm:col-span-2 md:col-span-1 group">
              <div className="flex items-center gap-3 mb-3 sm:mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-500/20 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:bg-cyan-500/30 transition-all">
                  <span className="text-xl sm:text-2xl">◈</span>
                </div>
                <div>
                  <div className="text-white font-semibold text-sm sm:text-base">Arcium Network</div>
                  <div className="text-gray-500 text-xs sm:text-sm">MPC Encryption</div>
                </div>
              </div>
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                Multi-Party Computation enabling encrypted computation on Solana with guaranteed execution.
              </p>
            </a>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="glass-card rounded-xl p-4 border-yellow-500/20">
                  <div className="flex items-center gap-2 text-yellow-400 text-sm mb-1">
                    <span>◉</span> Range API Production Key
                  </div>
                  <p className="text-gray-400 text-xs">Currently using mock fallback, awaiting prod access</p>
                </div>
                <div className="glass-card rounded-xl p-4 border-yellow-500/20">
                  <div className="flex items-center gap-2 text-yellow-400 text-sm mb-1">
                    <span>◉</span> Mainnet Deployment
                  </div>
                  <p className="text-gray-400 text-xs">Program deployment to mainnet-beta</p>
                </div>
                <div className="glass-card rounded-xl p-4 border-green-500/20">
                  <div className="flex items-center gap-2 text-green-400 text-sm mb-1">
                ...
                <div className="glass-card rounded-xl p-4 border-green-500/20">
                  ...
                  <p className="text-gray-400 text-xs">Pino logger, request throttling implemented</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-white">Phase 4: Advanced Features</h3>
                <span className="text-purple-400 text-xs sm:text-sm font-medium">📋 PLANNED</span>
              </div>
            </div>
            <div className="ml-5 pl-8 border-l-2 border-purple-500/30">
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="glass-card rounded-xl p-4 border-purple-500/20 opacity-80">
                  <div className="flex items-center gap-2 text-purple-400 text-sm mb-1">
                    <span>◇</span> Arcium C-SPL Integration
                  </div>
                  <p className="text-gray-400 text-xs">Unified MPC + CT in single transaction (ETA: Late Jan)</p>
                </div>
                <div className="glass-card rounded-xl p-4 border-purple-500/20 opacity-80">
                  <div className="flex items-center gap-2 text-purple-400 text-sm mb-1">
                    <span>◇</span> Squads Multi-sig UI
                  </div>
                  <p className="text-gray-400 text-xs">2-of-3 approval flows for enterprise treasuries</p>
                </div>
                <div className="glass-card rounded-xl p-4 border-purple-500/20 opacity-80">
                  <div className="flex items-center gap-2 text-purple-400 text-sm mb-1">
                    <span>◇</span> Recurring Payments UI
                  </div>
                  <p className="text-gray-400 text-xs">Cron-based automated payroll (backend ready)</p>
                </div>
                <div className="glass-card rounded-xl p-4 border-purple-500/20 opacity-80">
                  <div className="flex items-center gap-2 text-purple-400 text-sm mb-1">
                    <span>◇</span> Mobile Optimization
                  </div>
                  <p className="text-gray-400 text-xs">PWA support for on-the-go approvals</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card rounded-xl sm:rounded-2xl p-4 sm:p-6 mt-8">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-purple-400 font-bold text-sm sm:text-base">~85%</span>
            </div>
            <div className="h-3 bg-gray-800 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-green-500 via-purple-500 to-purple-400 rounded-full" style={{ width: '85%' }}></div>
            </div>
      ...
      <section className="relative z-10 px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-purple-500/20 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-center border border-purple-500/20 shadow-2xl">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 mt-6 sm:mt-8 text-xs sm:text-sm text-gray-400 flex-wrap">
            <span className="flex items-center gap-1" title="Arcium MPC">
              <span className="text-green-400">🔐</span> MPC Encrypted
            </span>
            <span className="flex items-center gap-1" title="Squads Protocol">
              <span className="text-blue-400">✓</span> Squads Verified
            </span>
            <span className="flex items-center gap-1" title="Helius RPC">
              <span className="text-purple-400">🛡️</span> Helius SOC 2
            </span>
          </div>
        </div>
      </section>
