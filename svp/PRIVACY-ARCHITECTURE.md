...
| File | Purpose |
|------|---------|
| `src/lib/cosigner/index.ts` | Co-signer client and service exports |
| `src/lib/cosigner/compliant-transfer.ts` | Compliance + CT integration |
| `src/app/api/payments/cosign/route.ts` | Co-sign API endpoint |
| `src/hooks/useCoSignedPayment.ts` | React hook for co-signed payments |
| `src/hooks/useConfidentialPayment.ts` | React hook for CT payments |
...
| `src/lib/confidential/index.ts` | Token-2022 instruction builders | ✅ Production |
| `src/lib/confidential/payment-service.ts` | Payment orchestration | ✅ Production |
| `src/app/api/payments/confidential/route.ts` | REST API endpoints | ✅ Production |
| `src/hooks/useConfidentialPayment.ts` | React hook | ✅ Production |
...
| `src/lib/confidential/payment-service.ts` | Payment orchestration service |
| `src/lib/cosigner/index.ts` | Co-signer client exports |
| `src/lib/cosigner/compliant-transfer.ts` | Compliance + CT integration |
| `src/app/api/payments/confidential/route.ts` | Confidential payment API |
| `src/app/api/payments/cosign/route.ts` | Co-signer endpoint |
